...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="description" content="Happy Birthday Nilam Dwi Cahya">
...
<body>
    ...
    <div class="balloons text-center" id="b15">
    	<h2 style="color:#20CFB4;">Y</h2>
    </div>
    <div class="balloons text-center" id="b16">
    	<h2 style="color:#20CFB4;">A</h2>
    </div>
	...
	<div class="container">
        ...
        <p>begitu spesial buat kamu</p>/
        <p>Isilah dengan senyuman terindah kamu</p>
        <p>dan jadikan itu kenangan terindah..</p>
        <p>selamat ulang tahun Nilam Dwi Cahya</p>
			</div>
		</div>
		<div class="navbar navbar-fixed-bottom">
			<div class="row">
				<div class="col-md-6 text-center col-md-offset-3">
					<button class="btn btn-primary" id="turn_on">Nyalain Lampunya Deh Biar Terang</button>
					<button class="btn btn-primary" id="play">Putar Musik</button>
					<button class="btn btn-primary" id="bannar_coming">Yuk Hiasi</button>
					<button class="btn btn-primary" id="balloons_flying">Terbangin Balonnya</button>
					<button class="btn btn-primary" id="cake_fadein">Nih Ada Kue-kuean</button>
					<button class="btn btn-primary" id="light_candle"> Nyalain Lilinnya</button>
					<button class="btn btn-primary" id="wish_message">HBD ya Cantik Maaf Baru Bisa Bikin Gini</button>
					<button class="btn btn-primary" id="story">Ada Pesan Buat Kamu</button>
